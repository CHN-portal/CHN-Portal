...
EXPECTED_HOLDER_NAMES = [
    ...
    "The CbdHealthNetwork Core developers\n",
]
...
Arguments:
    <base_directory> - The base directory of a CbdHealthNetwork Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The CbdHealthNetwork Core developers'
...
Arguments:
    <base_directory> - The base directory of CbdHealthNetwork Core source code repository.
"""
...
Arguments:
    <file> - A source file in the CbdHealthNetwork Core repository.
"""
