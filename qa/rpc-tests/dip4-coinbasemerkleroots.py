...
from test_framework.test_framework import CbdHealthNetworkTestFramework
...
class LLMQCoinbaseCommitmentsTest(CbdHealthNetworkTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as CbdHealthNetworkTestFramework doesn't support this atm)
