...
2. run cbdhealthnetworkd with -printalert or -sendalert like this:
   /path/to/cbdhealthnetworkd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.cbdhealthnetwork.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/CbdHealthNetwork Core:0.12.0.58/"));
