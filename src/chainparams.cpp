 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1575451812, nBits=1e0ffff0, nNonce=2254255, vtx=1)
...
{
    const char* pszTimestamp = "My future is righteousness";
    const CScript genesisOutputScript = CScript() << ParseHex("04edea31d1060019528cd2fd45a76ce655d89a352bd8c43578db318f46b4da8ab8de17c35361737508b12a9553e7f6c8a8621049b8b453d4546913732f4ed8b606") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x00000fb36bcafc7cb95c2eb87c753cef8383b3deb632a9571f21c08daf83163c"); 
        ...
        vAlertPubKey = ParseHex("0474562d80e25f1db7e5913273ec74f22bbb9f54f9232f0fada3905a2315fdf7773bf4002486197254fe319386e14446cfac966652ac3fadada03422d87b000d21");
        nDefaultPort = 14542;
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1575451812, 2254255, 0x1e0ffff0, 1, 1 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000fb36bcafc7cb95c2eb87c753cef8383b3deb632a9571f21c08daf83163c"));
        assert(genesis.hashMerkleRoot == uint256S("0x67c8d894f0209ec46f7b019bef2dea618acdd1463875c1f49761246d89a3a63d"));
        ...
        // CbdHealthNetwork BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // CbdHealthNetwork BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // CbdHealthNetwork BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"CLorqR7AtEDNSFu1aqutu4XF995W4tHy8C"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (  0, uint256S("0x00000fb36bcafc7cb95c2eb87c753cef8383b3deb632a9571f21c08daf83163c"))
        };

        chainTxData = ChainTxData{
            1575451812, // * UNIX timestamp of last known number of transactions (Block 1068571)
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00000bc6d27d56bdb2a355553fd148516409c2f60c09d27a9f6d07f37c403e11"); 

        pchMessageStart[0] = 0xfd;
        pchMessageStart[1] = 0x7e;
        pchMessageStart[2] = 0x5a;
        pchMessageStart[3] = 0xc5;
        vAlertPubKey = ParseHex("041c9a955f196e4c6bcf7ac61ada7f92a89222aa7f36651a1498a7ff52147c03e3baf4dc8d57c6d0694b87ac22819d74bc47035d17d3d7b17b643a313a271ff369");
        nDefaultPort = 24542;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1575451817UL, 83719UL, 0x1e0ffff0, 1, 1 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000bc6d27d56bdb2a355553fd148516409c2f60c09d27a9f6d07f37c403e11"));
        assert(genesis.hashMerkleRoot == uint256S("0x67c8d894f0209ec46f7b019bef2dea618acdd1463875c1f49761246d89a3a63d"));
        ...
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,156);
        // Testnet CbdHealthNetwork BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet CbdHealthNetwork BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet CbdHealthNetwork BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"CGvgiVP45Rv8mAv52V3gmvdBDSvYKXNrbC"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x00000bc6d27d56bdb2a355553fd148516409c2f60c09d27a9f6d07f37c403e11"))
        };

        chainTxData = ChainTxData{
            1575451817, // * UNIX timestamp of last known number of transactions (Block 96717)
            0,     // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1575451822, 0, 0x207fffff, 1, 1 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x4cb2c5166fe91a4de138ca57682abc52eb9fe6547358ec69adf82e33d6823d6a"));
        assert(genesis.hashMerkleRoot == uint256S("0x67c8d894f0209ec46f7b019bef2dea618acdd1463875c1f49761246d89a3a63d"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("cbdhealthnetworkevo.org",  "devnet-seed.cbdhealthnetworkevo.org"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0x4cb2c5166fe91a4de138ca57682abc52eb9fe6547358ec69adf82e33d6823d6a"))
...
public:
    CRegTestParams() {
        ...
        // privKey: 6Fkc1o1etsW3NHqLdcv99CV7Jztig3BLmC1QFaAP6hA17ZqF9xi
        vSporkAddresses = {"CUH9UeKto3ebHkoozczp5dTiNsCeXM4jaX"};
        nMinSporkKeys = 1;
        ...
        // Regtest CbdHealthNetwork addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,28);
        // Regtest CbdHealthNetwork script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,29);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,156);
        // Regtest CbdHealthNetwork BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest CbdHealthNetwork BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest CbdHealthNetwork BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
