...
#define BOOST_TEST_MODULE CbdHealthNetwork Test Suite

#include "test_cbdhealthnetwork.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_cbdhealthnetwork_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
