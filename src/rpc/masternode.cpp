...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner CbdHealthNetwork address\n"
            "  payee          - Print the masternode payout CbdHealthNetwork address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting CbdHealthNetwork address\n"
        );
}
...
UniValue masternode_outputs(const JSONRPCRequest& request)
{
    ...
    pwallet->AvailableCoins(vPossibleCoins, true, NULL, false, ONLY_420);
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "cbdhealthnetwork",               "masternode",             &masternode,             true,  {} },
    { "cbdhealthnetwork",               "masternodelist",         &masternodelist,         true,  {} },
    { "cbdhealthnetwork",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "cbdhealthnetwork",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
