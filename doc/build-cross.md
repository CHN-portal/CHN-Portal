Cross-compiliation of CbdHealthNetwork Core
===============================

CbdHealthNetwork Core can be cross-compiled on Linux to all other supported host systems. This is done by changing
the `HOST` parameter when building the dependencies and then specifying another `--prefix` directory when building CbdHealthNetwork.
...
When building CbdHealthNetwork Core, use
