...
This mechanism has been integrated into Bitcore-Node-CbdHealthNetwork which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cbdhealthnetworkpay/insight-api-cbdhealthnetwork#web-socket-api](https://github.com/cbdhealthnetworkpay/insight-api-cbdhealthnetwork#web-socket-api)
* API: [https://github.com/cbdhealthnetworkpay/insight-api-cbdhealthnetwork#instantsend-transactions](https://github.com/cbdhealthnetworkpay/insight-api-cbdhealthnetwork#instantsend-transactions)
