...
This document provides guidelines for internationalization of the CbdHealthNetwork Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `cbdhealthnetwork_en.ts` remains unchanged.
